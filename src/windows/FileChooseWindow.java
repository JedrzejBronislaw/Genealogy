...
public class FileChooseWindow extends JFrame implements ActionListener, ListSelectionListener {
	...
	public void setCoPo(Action coPo) {this.coPo = coPo;}
	...
	private void ustawKomponenty() {
		...
		ostatnioOtwarte = new JList(Settings.getOstatnioOtwarte());
