...
public class GrafStdPrzodkowie extends GrafDrzewa {
...
//	}
	...
	public GrafStdPrzodkowie() {}
	public GrafStdPrzodkowie(/*Drzewo drzewo, */Osoba osoba) {
//		this.drzewo = drzewo;
...
//		szerokosc = (osobaGlowna.rozmiarKorzenia()+1) * szerKolumny;
	...
	private int szerokoscRodzicow(FontMetrics fm, Osoba osoba, int pokolenie)
	{
	...
	private int rysujKorzen(Graphics2D g, Osoba osoba, int pokolenie, int y1)
	{		
