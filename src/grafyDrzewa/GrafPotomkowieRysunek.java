...
import grafyDrzewa.GrafPotomkowieRysunekObliczenia;
import grafyDrzewa.GrafPotomkowieRysunekObliczenia.DlugoscGalezi;
import grafyDrzewa.GrafPotomkowieRysunekObliczenia.Element;
...
import narzedzia.Gradient;

import dane.Osoba;

public class GrafPotomkowieRysunek extends GrafDrzewa {
	...
	public void rysuj(Graphics2D g) {
		...
		g.drawString("SzerokoϾ: " + OOsobie.szerokoscGaleziPotomkow(osobaGlowna)+"", 10, 40);
...
//		rysujGalaz(g, osobaGlowna, 1/*katPocz*/, srodekX, srodekY, 0);
		...
		GrafPotomkowieRysunekObliczenia obliczenia = new GrafPotomkowieRysunekObliczenia(osobaGlowna)
