...
public class GrafPotomkowieRysunekObliczenia {
	...
	public class Element
	{
		...
		public Element(Osoba osoba, int pokolenie, int x, int y) {
			this.osoba = osoba;
	...
	public GrafPotomkowieRysunekObliczenia setRoznicaDlugosciGaleziWzgledemRodzica(int roznica) {
		RoznicaDlugosciGaleziWzgledemRodzica = roznica;
		return this;
	}
	
	public GrafPotomkowieRysunekObliczenia setPoczatkowaOdlegloscMiedzyPokoleniami(int poczatkowaOdleglosc) {
		this.poczatkowaOdlegloscMiedzyPokoleniami = poczatkowaOdleglosc;
		return this;
	}
	public GrafPotomkowieRysunekObliczenia setOdlegloscMiedzyNajmlodszymiPokoleniami(int odleglosc) {
	...
	public GrafPotomkowieRysunekObliczenia setDlugoscGalezi(DlugoscGalezi dlugoscGalezi) {
		this.dlugoscGalezi = dlugoscGalezi;
		return this;
	}
	public GrafPotomkowieRysunekObliczenia setKatGalezi(KatGalezi katGalezi) {
		this.katGalezi = katGalezi;
		return this;
	}
	
	public GrafPotomkowieRysunekObliczenia setKatPocz(float katWStopniach) {
		this.katPocz = katWStopniach;
		return this;
	}
	public GrafPotomkowieRysunekObliczenia setKatCaly(float katWStopniach) {
		this.katCaly = katWStopniach;
		return this;
	}
	public GrafPotomkowieRysunekObliczenia setSymetrycznyKat(float szerokoscWSt) {
	...
	public GrafPotomkowieRysunekObliczenia(Osoba osobaGlowna) {
...
//			wysokosc = osobaGlowna.liczbaPokolenPotomkow()*poczatkowaOdlegloscMiedzyPokoleniami*2;//TODO doprecyzowaæ, zawêziæ
	...
	private Element rysujGalaz(Osoba osoba, double katOffset, int rodzicX, int rodzicY, int pokolenie)
	{
		int szer = OOsobie.szerokoscGaleziPotomkow(osobaGlowna);//-1;
		int szerCzesciowa = 0;
		int szerAkt = 0;
		Osoba dziecko;
		Point punkt;
...
//			setSymetrycznyKat(90+pokolenie*20);
			...
			szerAkt = OOsobie.szerokoscGaleziPotomkow(dziecko);
	...
	public GrafPotomkowieRysunekObliczenia setPrzesuniecie(int przesuniecieX,
			int przesuniecieY) {
